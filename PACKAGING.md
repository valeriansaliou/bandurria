...
2. **How to build Bandurria, package it and release it on Crates, GitHub and Docker Hub (multiple architectures):**
    ...
    3. Publish a changelog and upload all the built archives on the [releases](https://github.com/valeriansaliou/bandurria/releases) page on GitHub
