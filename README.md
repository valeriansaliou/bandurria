...
**Bandurria is a self-hosted lightweight comment system for static websites and blogs, with a built-in Proof-of-Work powered anti-bot. Built in Rust, it consumes only 4MB of RAM to run on your server. It can be included with a single line of JavaScript on your website (9KB!).**
