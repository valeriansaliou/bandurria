...
**Bandurria is a self-hosted lightweight comment system for static websites and blogs, with a built-in Proof-of-Work powered anti-bot. Built in Rust, it consumes only 4MB of RAM. Can be included with a single line of JavaScript (9KB!).**
