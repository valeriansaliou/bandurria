...
Bandurria comes as a lighter and even simpler alternative to Schnack, and does not require users to authenticate via OAuth to post their comment. Bandurria is a single tiny portable binary, that comes with an [official Docker image](https://hub.docker.com/r/valeriansaliou/bandurria/).
